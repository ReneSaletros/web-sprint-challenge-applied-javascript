...
1. What is the DOM?
DOM stands for document object model. The DOM defines a web page by using a model which is a tree that contains objects that have every element in order.
2. What is an event?
An event is the users interaction on the web site.
3. What is an event listener?
An event listener tracks the users interaction and can make changes to the web site based on the event being tracked.
